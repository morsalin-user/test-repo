  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-orange-500 mb-4">Our Products</h1>
          ...
          <div className="flex gap-2 mb-4 md:hidden">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="bg-orange-600 hover:bg-orange-700 text-white border-orange-600">
